...
class PenerapanBatikDetailFragment(mainActivity: MainActivity) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_penerapan_batik_detail, container, false)
    ...
    fun onBtnVideoClicked() {
        mainActivity.youtube(Server.YOUTUBE_PENERAPAN_BATIK)
    }

    @OnClick(R.id.btn_next)
    fun onBtnNextClicked() {
        mainActivity.penerapanRumahFragment()
    }
