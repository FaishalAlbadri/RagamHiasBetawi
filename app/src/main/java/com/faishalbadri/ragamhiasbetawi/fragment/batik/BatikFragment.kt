...
class BatikFragment(mainActivity: MainActivity) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_batik, container, false)
    ...
    fun onBtnNextClicked() {
        mainActivity.sejarahBatikDetailFragment()
    }
}