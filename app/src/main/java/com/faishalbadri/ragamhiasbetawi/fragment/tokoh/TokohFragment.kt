...
class TokohFragment(mainActivity: MainActivity) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_tokoh, container, false)
    ...
    fun onBtnNextClicked() {
        mainActivity.sejarahTokohDetailFragment()
    }
}