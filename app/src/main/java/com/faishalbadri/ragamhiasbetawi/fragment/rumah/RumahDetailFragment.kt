...
class RumahDetailFragment(mainActivity: MainActivity) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_rumah_detail, container, false)
    ...
    fun onBtnVideoClicked() {
        mainActivity.youtube(Server.YOUTUBE_PENERAPAN_RUMAH)
    }
